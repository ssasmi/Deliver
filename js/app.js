...
if (document.querySelector('.expos-slider')) {
	const expos = new Swiper('.expos-slider', {
		slidesPerView: 1,
		spaceBetween: 24,
		//centeredSlides: true,
		...
		navigation: {
			nextEl: '.expos__arrow.expos__arrow--left',
			prevEl: '.expos__arrow.expos__arrow--right',
		},
		pagination: {
